...
a. В регистре CX находится число шагов в цикле, равное 10.
b. В регистре BL находится начальный элемент массива, равный 1.
c. В регистре SI находится индекс начального элемента массива, равный 0.

Тело цикла:

1. Заносим содержимое BL в очередной байт массива simple[SI].
2. Увеличиваем SI на 1, чтобы перейти к следующему байту массива.
3. Увеличиваем BL на 1, чтобы получить следующее число для занесения в массив.
...
a. В регистре CX находится число шагов в цикле, равное 10.
b. В регистре SI находится индекс начального элемента массива, равный 0.
